...
module top (
  ...
  output wire external_tx_rfs;
  input wire external_rx_rfs;
  ...
  system the_system (
   ...
   .kernel_clk_clk										(kernel_clk),
	...
	.acl_iface_uart_external_rxd         (external_tx_rfs),         // acl_iface_uart_external.rxd
	.acl_iface_uart_external_txd         (external_rx_rfs)          //                        .txd
